...
//void JV_SEED_CBC128_Decrypt(uint8_t *in, uint8_t *out, size_t len, const void *key, uint8_t ivec[SeedBlockSize]);
void JV_SEED_CBC128_Decrypt_OneBlock(uint8_t *in, uint8_t *out, const uint32_t *key, uint8_t ivec[SeedBlockSize]);
